...
export default function ChatBox() {
  ...
  const regenerateResponse = async (index: number) => {
    ...
    setRegeneratingIndex(index); // 👈 Show loader for this message
    ...
    try {
      ...
      setMessages((prev) =>
        prev.map((msg, i) =>
          i === index ? { role: "assistant", content: data.content } : msg
        )
      );
    } catch (err) {
      toast.error("Failed to regenerate response");
    } finally {
      setRegeneratingIndex(null); // 👈 Hide loader
    }
  };
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full space-y-4">
            <div
              className={`w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center overflow-hidden`}
            >
              <Image
                src="/logo.jpeg"
                alt="Hitesh Sir"
            ...
            <div className="text-center">
              ...
              >
                Hi! I'm Hitesh Sir's AI persona. Ask me anything about
                programming, technology, web development, or any topic you want
                to learn about. I'm here to help you grow!
              </p>
            </div>
          </div>
        )}
        ...
        {messages.map((msg, i) => (
          ...
          >
            ...
            <div
              className={`max-w-md ${msg.role === "user" ? "order-first" : ""}`}
            >
              <div
              ...
              {msg.role === "assistant" && (
                <div className="flex items-center space-x-2 mt-2">
                  <button
                    ...
                    className={`text-xs hover:text-gray-700 p-1 rounded-sm font-semibold ${
                      darkMode
      ...
      >
        <div className="flex items-center space-x-3">
          <div className="flex-1 relative">
            <div
              className={`flex items-center space-x-2 px-3 py-2 border rounded-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 ${
                darkMode
